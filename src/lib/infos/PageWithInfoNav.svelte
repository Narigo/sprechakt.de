...
<PageWithNavigation>
	<nav slot="navigation">
		...
		<li>
			<a class:active={currentUrl.startsWith(`${base}/infos/acts`)} href={`${base}/infos/acts`}
				>Für Künstler:Innen</a
			>
		</li>
		<li>
			<a class:active={currentUrl.startsWith(`${base}/infos/coops`)} href={`${base}/infos/coops`}
				>Kooperationen</a
			>
		</li>
		<li>
